  ...
  return (
    <div className="min-h-lvh mx-auto px-6 py-8 text-gray-800 bg-pink dark:text-white" >
      ...
      <p className="mb-3">
        ...
        games here, from classics and strategy hits to fun party games and cozy
        adventures.
      </p>
      <p className="mb-3">
        You can play online with friends, join open lobbies to meet new people,
        or even enjoy a solo game when you just want to relax with a cup of tea.
      </p>
      <p className="mb-3">
